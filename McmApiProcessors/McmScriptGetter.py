...
from McmApiLib.McmScriptGetterBase import (  # pylint: disable=import-error, wrong-import-position
    McmScriptGetterBase,
)

__all__ = ["McmScriptGetter"]

class McmScriptGetter(McmScriptGetterBase):
    description = """AutoPkg Processor to connect to an MCM Admin
    Service and retrieve a script object, if it exists
    """
    input_variables = {
        ...
        "script_name": {
            "required": True,
            "description": "The name of the script in MCM to search for."
        },
        "mcm_script_getter_export_properties": {
            "required": False,
            "default": {},
            "description": 
    ...
    output_variables = {
        "mcm_script_found": {
            "description": "Returns True if the script was found in the MCM instance, otherwise, returns false."
        },
        "mcm_script_guid": {
            "description": "The GUID of the script in MCM, if found."
        },
        "mcm_script_object_path": {
            "description": "The WMI ObjectPath of the script in MCM, if found."
        },
        "mcm_script_content_raw": {
            "description": "The content of the script in MCM as returned by the AdminService (in Base64), if found."
        },
        "mcm_script_content": {
            "description": "The content of the script in MCM as returned by the AdminService (decoded from Base64), if found."
        },
    }
