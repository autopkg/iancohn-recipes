...
from McmApiLib.McmScriptUploaderBase import (  # pylint: disable=import-error, wrong-import-position
    McmScriptUploaderBase,
)

__all__ = ["McmScriptUploader"]

class McmScriptUploader(McmScriptUploaderBase):
    description = """AutoPkg Processor to connect to an MCM Admin
    Service and upload a script object, if it exists
    """
    input_variables = {
        ...
        "mcm_script_guid": {
            "required": False,
            "description": "The GUID of the script to upload. If not specified, or if '', a new script will be created.",
            "default": ""
        },
        "mcm_script_name": {
            "required": True,
            "description": "The name of the script in MCM to upload."
        },
        "mcm_script_description": {
            "required": False,
            "description": "The description of the script in MCM to upload.",
            "default": ""
        },
        "mcm_script_timeout": {
            "required": False,
            "description": 
                "The timeout (in seconds) of the script in MCM to upload. "
                "Min: 60, Max: 1800",
            "default": 60
        },
        "mcm_script_parameters": {
            "required": False,
            "description": "An array of parameters to upload with the script in MCM.",
            "default": []
        },
        "mcm_script_uploader_export_properties": {
            "required": False,
            "default": {
                "mcm_script_guid": {"type": "property", "raise_error": True,"options": {"property": "ScriptGuid"}},
            },
            "description": 
        ...
        "mcm_overwrite_existing_script": {
            "required": False,
            "description": "If , overwrite the existing script in MCM.",
            "default": False
        },
    }
    output_variables = {}
