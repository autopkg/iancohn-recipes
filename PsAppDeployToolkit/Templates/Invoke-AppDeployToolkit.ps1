...
$adtSession = @{
    # App variables.
    AppVendor = '%PSADT_APP_VENDOR%'
    AppName = '%PSADT_APP_NAME%'
    AppVersion = '%version%'
    AppArch = '%PSADT_APP_ARCH%'
    AppLang = 'EN'
    AppRevision = '01'
    ...
    RequireAdmin = %PSADT_REQUIRE_ADMIN%
